...
<!-- Mirrored from UET_h1.kenzap.com/register-page.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Feb 2017 10:05:43 GMT -->
<head>
    <meta charset="UTF-8">
                ...
                <div class="account-content">
                    <form action="register.jsp" method="post">
                        ...
                        <div class="input-box number">
                            <input type="text" placeholder="Registeration Number" name="regNum" required >
                        </div>
                        <div class="input-box email">
                            <input type="email" placeholder="Email Address" name="email">
                        </div>
                        <div class="input-box password">
                            <input type="password" placeholder="Minimum six characters" id="password" name="pwd1" pattern=".{6,}">
                        </div>
                        <div class="input-box very-password">
                            <input type="password" placeholder="Verify Password" oninput ="check(this)" name="pwd2" pattern=".{6,}">
                        </div>
                        ...
                        <div class="buttons-set">
                            <button  title="REGISTER" class="bnt bnt-theme text-regular text-uppercase btn btn-lg" type="submit">REGISTER</button>
                        </div>
                    </form>
                </div>
            </div>
