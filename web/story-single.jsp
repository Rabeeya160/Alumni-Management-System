...
<!-- Mirrored from UET_h1.kenzap.com/story-single.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Feb 2017 10:05:41 GMT -->
<head>
    <meta charset="UTF-8">
        ...
        <div class="story-single">
            <div class="cover-img">
                ...
                <div class="area-title">
                    <div class="container">
                        <h2 class="heading-light">Taliah Tajammal</h2>
            ...
            <div class="story-content">
                <div class="container">
                    ...
                    <div class="desc-border text-center">
                        ...
                        <p>Taliah Tajammal born in Yogyakarta, Indonesia 29 April 1990.
                        ...
                        <div class="col-sm-6 col-xs-6">
                            <div class="box-content box-left">
                                <a href="#" class="text-left">
                                    ...
                                    <h4 class="story-title text-regular">Romaisa Ghori : A Stronger Sense of Belonging</h4>
                                </a>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xs-6">
                            <div class="box-content box-right">
                                <a href="#" class="text-right">
                                    ...
                                    <h4 class="story-title text-regular">Huma Ayaz : Sharing Her Creative Gifts</h4>
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <ul class="list-comments">
                            <li>
                                ...
                                <div class="user-comments">
                                    <h4 class="heading-regular"> Adnan Khan</h4>
                            ...
                            <li>
                                ...
                                <div class="user-comments">
                                    <h4 class="heading-regular"> Zoha </h4>
...
<!-- Mirrored from UET_h1.kenzap.com/story-single.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Feb 2017 10:05:43 GMT -->
</html>