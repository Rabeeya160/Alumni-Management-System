...
<!-- Mirrored from UET_h1.kenzap.com/index.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Feb 2017 10:02:20 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <div class="header-wrapper header-position">
        <header id="header" class="container-header type1">
                            ...
                            <ul class="list-inline">
                                ...
                                <li>
                                    <a href="#">
                                        ...
                                        <span class="text"> 0334 4769091</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="header-middle">
                <div class="container">
                    <div class="logo hidden-sm hidden-xs text-center">
                        <a href="#"> <img src="images/ulogo.png" alt="logo" height="120px" width="120px"></a>
                    </div>
                    <div class="menu">
                        <nav>
                ...
                <div class="item">
                    ...
                    <div class="owl-caption">
                        <div class="container">
                            <div class="content-block">
                                <h2>
                                    <span class="text-bold">UET professor explores</span> <br />
                            ...
                            <div class="row">
                                <div class="col-sm-10 col-xs-9">
                                    ...
                                    <span>
                                        ...
                                        <span class="text-place text-light animated fadeInRight">Allah Wali Gali,GT Road Lahore</span>
                                    </span>
                                </div>
        ...
        <div class="alumni-dashboard">
            <div class="container">
                <div class="title title-dashboard type1">
                    <h3 class="heading-light no-margin"> My UET Alumni Dashboard </h3>
                </div>
                <div class="area-content">
                    <div class="row">
                        ...
                        <div class="login-dashboard text-center col-sm-12 col-xs-12">
                            <a href="login-page.jsp" class="bnt bnt-theme login-links">LOG IN TO ALUMNI DASHBOARD</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="block-news col-md-4 col-sm-12 col-xs-12">
                        <div class="column-news">
                            ...
                            <div class="post-wrapper">
                                <div class="post-item clearfix ">
                                    ...
                                    <div class="post-desc-wrapper">
                                        <div class="post-desc">
                                            <div class="post-title"><h6 class="heading-regular"><a href="#">New UET "Start-Up" in Distrupt 2016</a></h6></div>
                                ...
                                <div class="post-item clearfix ">
                                    ...
                                    <div class="post-desc-wrapper">
                                        <div class="post-desc">
                                            <div class="post-title"><h6 class="heading-regular"><a href="#">UET Library Gives Alumni New Access</a></h6></div>
                                            <div class="post-excerpt">
                                                <p>Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium.</p>
                                            </div>
                                        </div>
                                ...
                                <div class="post-desc-wrapper">
                                    <div class="post-desc">
                                        <div class="post-title"><h6 class="heading-regular"><a href="#">UET in Silicon Valley: Family and Finance</a></h6></div>
                                        <div class="post-excerpt">
                                            <p>Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium.</p>
                                        </div>
                                    </div>
                            ...
                            <div class="view-all"><a href="blog.jsp">View All News</a></div>
                        </div>
                    </div>
                    <div class="block-career col-md-4 col-sm-12 col-xs-12">
                        <div class="column-career">
                            ...
                            <div class="view-all"><a href="career-opportunity.jsp">View All Career Opportunity</a></div>
                        </div>
                    ...
                    <div class="block-event-calendar col-md-4 col-sm-12 col-xs-12">
                        <div class="column-calendar">
                            ...
                            <div class="content-calendar bg-calendar no-padding">
                                ...
                                <div class="list-view">
                                        ...
                                        <div class="date-desc-wrapper">
                                            <div class="date-desc">
                                                ...
                                                <div class="date-excerpt">
                                                    <p>Organizer: UET Black Alumni Association</p>
                                                </div>
                                                <div class="place">
                                                    <span class="icon map-icon"></span>
                                    ...
                                    <div class="view-item">
                                        ...
                                        <div class="date-desc-wrapper">
                                            <div class="date-desc">
                                                <div class="date-title"><h6 class="heading-regular">Weekend at UET Sierra Camp</h6></div>
                                                <div class="date-excerpt">
                                                    <p>Organizer: UET Black Alumni Association</p>
                                                </div>
                                                <div class="place">
                            ...
                            <div class="view-all"><a href="programs-events.jsp">View All Events</a></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12 pull-right">
                        <div class="interview-wrapper">
                            <div class="interview-title">
                                ...
                                <h1 class="heading-light text-capitalize">Taliah Tajammal</h1>
                            </div>
                            ...
                            <div class="interview-see-story">
                                <a href="story-single.jsp" class="see-story bnt text-uppercase">SEE Taliah STORY</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="twitter-content">
                        <div class="twitter-desc">
                            <p class="text-light text-center">“I feel fortunate to be joining my classmates in welcoming the Class of
                                2016 to the UET alumni community <a href="#">@UETEdu</a> <a href="#">@UETEdu</a>“</p>
            ...
            <div class="instagram-feed clearfix">
                ...
                <div class="instagram-feed-user text-center">
                    <div class="user-wrapper">
                        ...
                        <span class="name-user">@UETEdu</span>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Mirrored from UET_h1.kenzap.com/index.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Feb 2017 10:03:24 GMT -->
</html>